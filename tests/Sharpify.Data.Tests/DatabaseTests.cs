...
public partial class DatabaseTests {
    ...
    public void SpanBasedByteReadWrite() {
        ...
        using var buffer = db.TryReadToRentedBuffer("test", "", 1);
        buffer.WriteAndAdvance(6);
        db.Upsert("test", buffer.WrittenSpan);
    ...
    public void SpanBasedTReadWrite() {
        ...
        using var buffer = db.TryReadToRentedBuffer<Person>("1", "", 1);
        buffer.WriteAndAdvance(p3);
        db.UpsertMany("1", buffer.WrittenSpan);
